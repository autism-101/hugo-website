...
;
jQuery.event.special.touchstart={setup:function(e,t,n){"use strict";this.addEventListener("touchstart",n,{passive:!t.includes("noPreventDefault")})}},jQuery.event.special.touchmove={setup:function(e,t,n){"use strict";this.addEventListener("touchmove",n,{passive:!t.includes("noPreventDefault")})}},$(window).on("load",function(){"use strict";$(".preloader").fadeOut(0)}),$(document).ready(function(){"use strict";if($(".tab-content").find(".tab-pane").each(function(){var n=$(this).closest(".code-tabs").find(".nav-tabs"),s=$(this).attr("title");n.append('<li class="nav-item"><a class="nav-link" href="#">'+s+"</a></li>")}),$(".code-tabs ul.nav-tabs").each(function(){$(this).find("li:first").addClass("active")}),$(".code-tabs .tab-content").each(function(){$(this).find("div:first").addClass("active")}),$(".nav-tabs a").click(function(e){e.preventDefault();var t=$(this).parent(),s=t.index(),n=$(this).closest(".code-tabs"),o=n.find(".tab-pane").eq(s);n.find(".active").removeClass("active"),t.addClass("active"),o.addClass("active")}),$(".video-play-btn").on("click",function(){var e=$(this).siblings(".video-thumb").width(),t='<div class="ratio ratio-16x9 mx-auto bg-dark rounded-2 overflow-hidden" style="max-width:'+e+'px"><iframe src="'+$(this).data("src")+'?autoplay=1&amp;modestbranding=1&amp;showinfo=0" allowscriptaccess="always" allow="autoplay" allowfullscreen></iframe></div>';$(this).fadeOut(100),$(this).siblings(".video-thumb").replaceWith(t)}),$(".counter").length!==0){var e=0;$(window).scroll(function(){var t=$(".counter").offset().top-window.innerHeight;e==0&&$(window).scrollTop()>t&&($(".counter").each(function(){var e=$(this),t=e.attr("data-count");$({countNum:e.text()}).animate({countNum:t},{duration:850,easing:"swing",step:function(){e.text(Math.ceil(this.countNum).toLocaleString("en"))},complete:function(){e.text(Math.ceil(this.countNum).toLocaleString("en"))}})}),e=1)})}new Swiper(".swiper.single-slider",{loop:!0,autoplay:!0,pagination:{el:".swiper-pagination",clickable:!0}}),new Swiper(".swiper.brand-carousel",{spaceBetween:0,speed:1e3,loop:!0,autoplay:{delay:3e3},breakpoints:{0:{slidesPerView:2,spaceBetween:0},640:{slidesPerView:3,spaceBetween:0},767:{slidesPerView:4,spaceBetween:0},991:{slidesPerView:6,spaceBetween:0}}}),new Swiper(".swiper.testimonial-carousel",{spaceBetween:70,speed:600,loop:!0,autoplay:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:30},991:{slidesPerView:2,spaceBetween:70}},pagination:{el:".swiper-pagination",clickable:!0}})})